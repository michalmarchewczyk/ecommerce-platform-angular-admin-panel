...
import { DeliveryMethodAddFormComponent } from './delivery-method-add-form.component';
...
describe('DeliveryMethodAddFormComponent', () => {
  ...
  let fixture: ComponentFixture<DeliveryMethodAddFormComponent>;
  let store: MockStore;
  ...
  it('should dispatch createDeliveryMethod action', async () => {
    ...
    const expected = cold('a', {
      a: DeliveryMethodsActions.createDeliveryMethod({
        data: {
          name: 'name',
